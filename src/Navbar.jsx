...
const Navbar= ()=>
{
  ...
  <div className="container-fluid">
    <NavLink activeClassName='menu_active' exact className="navbar-brand" to="/">The Engineer Girl</NavLink>
    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
      <ul className="navbar-nav ms-auto mb-2 mb-lg-0">
        ...
        <li className="nav-item">
          <NavLink activeClassName='menu_active' exact className="nav-link" to="/services">My Works</NavLink>
        </li>
